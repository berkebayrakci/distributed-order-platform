...
ALTER TABLE product_order DROP CONSTRAINT ck_crm_product_order_action;
ALTER TABLE product_order DROP CONSTRAINT ck_crm_product_order_action_shape;

ALTER TABLE product_order ADD CONSTRAINT ck_crm_product_order_action
    CHECK (action IN ('ADD', 'REMOVE', 'CHANGE'));
ALTER TABLE product_order ADD CONSTRAINT ck_crm_product_order_action_shape
    CHECK (
